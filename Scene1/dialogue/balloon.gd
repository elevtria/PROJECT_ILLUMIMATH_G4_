...
@onready var boy_mc_smile = %BoyMCSmile
...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		var portrait_path: String = "res://CharactersforDialogue/MALEMC/%s.png" % dialogue_line.character.to_lower()
		if FileAccess.file_exists(portrait_path):
			boy_mc_smile.texture = load(portrait_path)
		else:
			boy_mc_smile.texture = null
